export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'Educational slot machine simulator — play eleven authentic archetypes, run bankroll-risk simulations in the Sim Lab, and explore the math the floor never shows in the /learn section.' },
        { property: 'og:title', content: 'Slots Simulator' },
        { property: 'og:description', content: 'Eleven machines, a Monte-Carlo Sim Lab (risk of ruin, survival curve, drawdown histograms), and /learn explainers on house edge, virtual reels, and hold-and-spin math.' },
        ...
        { name: 'twitter:description', content: 'Eleven machines, a Monte-Carlo Sim Lab (risk of ruin, survival curve, drawdown histograms), and /learn explainers on house edge, virtual reels, and hold-and-spin math.' },
