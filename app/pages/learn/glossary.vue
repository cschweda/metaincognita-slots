...
const entries: Entry[] = [
  ...
  { id: 'sd-per-coin', term: 'Standard deviation (sd/coin)', def: 'The volatility number on the machine cards: how far one spin\'s result typically swings from the average, per coin bet. Higher sd = wilder ride at the same RTP.', link: { to: '/learn/volatility', label: 'every machine\'s sd, live' } },
  ...
  { id: 'volatility', term: 'Volatility (variance)', def: 'How wild the ride is at the same RTP. Low volatility pays small and often; high volatility starves you between rare big hits. Two machines can share an RTP and feel nothing alike.', link: { to: '/learn/volatility', label: 'the floor, ranked by wildness' } },
