...
const topics = [
  ...
  { to: '/learn/volatility', icon: 'i-lucide-activity', title: 'Volatility: same edge, different ride', blurb: 'Two machines can share an RTP while one starves you between jackpots — sd/coin and N₀ for the whole floor, live.' },
  ...
  <div class="px-4 py-8 max-w-[900px] mx-auto space-y-8">
    <header class="space-y-2">
      <h1 class="text-4xl font-bold tracking-tight">
        <span class="text-amber-400">Learn</span> the math
      </h1>
    ...
    >
      <UIcon
        ...
        class="w-4 h-4"
      />
      See it in action in the Sim Lab →
    </NuxtLink>
  </div>
</template>
